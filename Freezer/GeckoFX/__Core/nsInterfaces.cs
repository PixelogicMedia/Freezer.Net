...
namespace Gecko
{
    ...
    internal delegate int nsWriteSegmentFun(
    ...
    internal static class nsIHttpActivityObserverConstants
    {
    ...
    internal static class nsISocketTransportConstants
    {
