...
#pragma warning restore 169
    ...
    [StructLayout(LayoutKind.Sequential)]
    internal class nsAUTF8StringBase
        : IString
    {
...
#pragma warning restore 169
    ...
    [StructLayout(LayoutKind.Sequential)]
    internal class nsAUTF8String : nsAUTF8StringBase, IDisposable
    {
...
#pragma warning restore 169
    ...
    [StructLayout(LayoutKind.Sequential)]
    internal class nsACString : nsACStringBase, IDisposable
    {
        public nsACString()
        {
            NS_CStringContainerInit(this);
    ...
    internal abstract class nsAStringBase
        : IString, IDisposable
    {
    ...
    internal sealed class nsAString : nsAStringBase
    {
