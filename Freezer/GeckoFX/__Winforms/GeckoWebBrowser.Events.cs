...
namespace Gecko
{
    partial class GeckoWebBrowser
    {
        ...
        internal sealed class ConsoleListener
            : nsIConsoleListener
        {
    ...
    internal class GeckoHistoryEventArgs
        : CancelEventArgs
    {
        /// <summary>
    ...
    /// <summary>Provides data for event.</summary>
    internal class GeckoHistoryGotoIndexEventArgs
    ...
    /// <summary>Provides data for event.</summary>
    internal class GeckoHistoryPurgeEventArgs
        : CancelEventArgs
    {
        /// <summary>
    ...
    internal class GeckoHistoryRepalaceEntryEventArgs : CancelEventArgs
    {
        public readonly int Index;
    ...
    /// <summary>Provides data for event.</summary>
    internal class GeckoRequestProgressEventArgs
        : EventArgs
    {
    ...
    /// <summary>Provides data for  event.</summary>
    internal class GeckoProgressEventArgs
        : EventArgs
    {
        public readonly long CurrentProgress;
        public readonly long MaximumProgress;
    ...
    /// <summary>Provides data for event.</summary>
    internal class GeckoNavigatedEventArgs
        : EventArgs
    {
    ...
    /// <summary>Provides data for event.</summary>
    internal class GeckoRedirectingEventArgs
        : CancelEventArgs
    {
        public readonly Uri Uri;
        public readonly GeckoWindow DomWindow;
    ...
    /// <summary>Provides data for event.</summary>
    internal class GeckoCreateWindowEventArgs
        : CancelEventArgs
    {
    ...
    /// <summary>Provides data for event.</summary>
    internal class GeckoCreateWindow2EventArgs
    ...
    /// <summary>Provides data for event.</summary>
    internal class GeckoWindowSetBoundsEventArgs
        : EventArgs
    {
    ...
    /// <summary>Provides data for event.</summary>
    internal class GeckoContextMenuEventArgs
        : EventArgs
    {
        /// <summary>
    ...
    /// <summary>Provides data for event.</summary>
    internal class GeckoObserveHttpModifyRequestEventArgs
        : CancelEventArgs
    {
        public readonly Uri Uri;
