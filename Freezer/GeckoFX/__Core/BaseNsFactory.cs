...
namespace Gecko
{
    internal class FactoryDetails
    {
        public Guid classID;
        public nsIFactory factoryInstance;
    }

    internal class BaseNsFactory<TFactory>
...
// ReSharper restore StaticFieldInGenericType
    ...
    internal sealed class ContractIDAttribute
        : Attribute
    {
    ...
    internal class GenericOneClassNsFactory<TFactory, TType>
