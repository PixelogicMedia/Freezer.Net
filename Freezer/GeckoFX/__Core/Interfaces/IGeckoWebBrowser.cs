...
namespace Gecko
{
    ...
    #region internal enum GeckoLoadFlags

    [Flags]
    internal enum GeckoLoadFlags
    {
        /// <summary>
    ...
    internal interface IGeckoWebBrowser
    {
        #region Properties
    ...
    #region internal enum GeckoWindowFlags

    [Flags]
    internal enum GeckoWindowFlags
    {
        Default = 0x1,
        WindowBorders = 0x2,
        WindowClose = 0x4,
