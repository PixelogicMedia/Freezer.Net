...
namespace Gecko
{
    ...
    /// </summary>
    internal partial class GeckoWebBrowser :
        IGeckoWebBrowser,
        nsIWebBrowserChrome,
...
#warning when geckoFX is used in WPF application there are no forms. We should rewrite this code
    ...
    #region internal enum GeckoSecurityState

    internal enum GeckoSecurityState
    {
        /// <summary>
    ...
    internal class GeckoJavaScriptHttpChannelWrapper : nsIDOMEventListener
    {
