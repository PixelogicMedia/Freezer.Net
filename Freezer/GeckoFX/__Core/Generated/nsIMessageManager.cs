...
namespace Gecko
{
	...
	internal interface nsIMessageListener
	{
	...
	internal interface nsIMessageListenerManager
	{
	...
	internal interface nsIMessageSender : nsIMessageListenerManager
	{
	...
	internal interface nsIMessageBroadcaster : nsIMessageListenerManager
	{
	...
	internal interface nsISyncMessageSender : nsIMessageSender
	{
	...
	internal interface nsIMessageManagerGlobal : nsISyncMessageSender
	{
	...
	internal interface nsIContentFrameMessageManager : nsIMessageManagerGlobal
	{
	...
	internal interface nsIInProcessContentFrameMessageManager : nsIContentFrameMessageManager
	{
	...
	internal interface nsIContentProcessMessageManager : nsIMessageManagerGlobal
	{
	...
	internal interface nsIFrameScriptLoader
	{
	...
	internal interface nsIProcessScriptLoader
	{
	...
	internal interface nsIGlobalProcessScriptLoader : nsIProcessScriptLoader
	{
	...
	internal interface nsIProcessChecker
	{
